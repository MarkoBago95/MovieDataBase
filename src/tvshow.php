      ...
      <?php
        ...
        foreach($tv_id_similar->results as $sim){
           echo '<div class="column2">
                  <div class="row2">
                  <a href="movie.php?id='.$sim->id.'"><img src="http://image.tmdb.org/t/p/w300'.$sim->backdrop_path.'" width="280" height="200" ></a><h5><span style="color:#aee8e0;text-align:center;">'.$sim->original_name.'</h5>
                   </div>
                  </div>';
